...
class TransitOutStrategy : public InternalStrategy
{
public:
  ...
  StrategyType get_type() const override { return StrategyType::TRANSIT_OUT; }
  std::string get_name() const override { return "TRANSIT_OUT"; }
...
private:
  ...
  double transit_altitude_above_home_m_{15.0};
